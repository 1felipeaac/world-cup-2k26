...
export const Teams: Team[] = [
    ...
    createTeam(3, "Coréia do Sul", "korea-republic"),
    ...
    createTeam(21, "Holanda", "netherlands"),
    ...
    createTeam(30, "Cabo Verde", "cape-verde"),
    ...
    createTeam(41, "Portugal", "portugal"),
    createTeam(42, "Congo", "congo-dr"),
    createTeam(43, "Usbequistão", "uzbekistan"),
